...
<head>
    ...
    <title><?= $Settings->site_name; ?> Promotional Page</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for <?= $Settings->site_name; ?></h1>
                    <p class="lead"><?= $Settings->site_name; ?> is php based web application for small and medium businesses to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    <!-- <p>Please edit themes/<?=$Settings->theme;?>/views/promotions.php</p> -->
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p><?= $Settings->site_name; ?> by <a href="#">JinanIT</a>.</p>
                    </div>
                </div>
            </div>
        </div>
