 ...
 */
$config['site_title']                 = "Jinan POS";       // Site Title, example.com This is not more functional
$config['admin_email']                = "info@jinanpos.com"; // Admin Email, admin@example.com This is not more functional
